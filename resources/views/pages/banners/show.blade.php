                            ...
                            <form method="POST" id="form-banner" class="form-horizontal">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label class="control-label" for="cmb_empresa">Menú<span
                                                class="text-danger">(*)</span></label>
                                        <label class="field select">
                                            <select id="cmb_menu" name="menu_web_id" class="form-control gui-input"
                                                placeholder="Seleccione menú" disabled>
                                                <option></option>
                                                @foreach ($menus as $menu)
                                                    <option value="{{$menu->id}}" @if($menu->id == $banner->menu_web_id) selected
                                                    @endif>{{$menu->nombre}}</option>
                                                @endforeach
                                            </select>
                                        </label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label class="control-label" for="cmb_empresa">Tipo<span
                                                class="text-danger">(*)</span></label>
                                        <label class="field select">
                                            <select id="cmb_tipo_banner" name="tipo_banner_id"
                                                class="form-control gui-input" placeholder="Seleccione tipo" disabled>
                                                <option></option>
                                                @foreach ($tipo_banners as $tipo)
                                                    <option value="{{$tipo->id}}" @if($tipo->id == $banner->tipo_banner_id)
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <label class="field">
                                            <input type="text" name="title" class="form-control gui-input"
                                                placeholder="titulo" value="{{$banner->title}}" readonly>
                                        </label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <label class="field">
                                            <input type="text" name="link" class="form-control gui-input" placeholder="link"
                                                value="{{$banner->link}}" readonly>
                                        </label>
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <div class="tinymce-wrap">
                                            <textarea id="txt_description" name="description"
                                                class="form-control mt-15 gui-input tinymce"
                                            ...
                                            <div class="avatar-icon-wrapper mr-2 avatar-icon-xl">
                                                <div class="avatar-icon">
                                                    <img class="rounded-circle img-custom"
                                                        src="{{asset('storage/images/banners')}}/{{$banner->id}}/{{$banner->image}}"
                                    ...
                                    @if($banner->icon)
                                        <div class="col-md-6 form-group">
                                            ...
                                            <div class="avatar-icon-wrapper mr-2 avatar-icon-xl">
                                                <div class="avatar-icon">
                                                    <img class="rounded-circle img-custom"
                                                        src="{{asset('storage/images/banners')}}/{{$banner->id}}/{{$banner->icon}}"
                                                        alt="" title="" width="100px" height="100px">
                                                </div>
                                            </div>
