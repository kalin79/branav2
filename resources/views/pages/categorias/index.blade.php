        ...
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                ...
                <div class="d-inline-block" style="background: white">
                    <a href="{{ route('categories.create',$categoria->id) }}" class="btn btn-outline-2x btn-outline-primary entity-create ">
...
@push('scripts')
    ...
    <script>
        var url_categories_load = "{{ route('categories.load',$categoria->id) }}";
