    ...
    <div class="modal-body admin-form">
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <label class="field">
                    <input class="form-control gui-input" id="titulo" name="titulo" placeholder="" required
                        value="{{$categoria->titulo}}" type="text">
                </label>
        ...
        @if($parent_id == 0)
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <div class="custom-file">
                        <input accept="image/*" class="custom-file-input" id="poster" lang="es" type="file" name="images">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <div class="custom-file">
                        <input accept="image/*" name="image_mobile" class="custom-file-input" id="image_mobile" lang="es"
                            type="file">
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <div class="custom-file">
                        <input accept="image/*" class="custom-file-input" id="icon" lang="es" type="file" name="icon">
