...
<form action="{{ route('categories.update',$categoria->id) }}" method="POST" id="form-categoria-edit"
    ...
    <div class="modal-body admin-form">
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <label class="field">
                    <input class="form-control gui-input" id="titulo" name="titulo" placeholder=""
                           required value="{{$categoria->titulo}}"
                           type="text">
                </label>
            ...
            <div class="form-group col-md-6">
                ...
                <label class="field">
                    <input class="form-control gui-input" id="color" name="color" placeholder="" type="text" value="{{$categoria->color}}">
                </label>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="descripcion" id="description">{{$categoria->descripcion}}</textarea>
        </div>
        @if($parent_id==0)
        <div class="row" >
        ...
        <div class="row" >
            <div class="col-sm-6">
                <div class="font-icon-wrapper float-left mr-3 mb-3">
                    <img src="{{asset('images/categoria')}}/{{$categoria->id}}/{{$categoria->poster}}" class="rounded-circle img-custom"
                         id='img-upload'
                         width="100"/>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="font-icon-wrapper float-left mr-3 mb-3">
                    <img src="{{asset('images/categoria')}}/{{$categoria->id}}/{{$categoria->poster_mobile}}" class="rounded-circle img-custom"
        ...
        <div class="row" >
            <div class="col-sm-6">
                <div class="font-icon-wrapper float-left mr-3 mb-3">
                    <img src="{{asset('images/categoria')}}/{{$categoria->id}}/{{$categoria->icono}}" class="rounded-circle img-custom"
                         id='img-upload-icon'
