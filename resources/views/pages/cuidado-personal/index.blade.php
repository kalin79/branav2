        ...
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                ...
                <div class="d-inline-block" style="background: white">
                    <a href="{{ route('cuidado-personal.create') }}" class="btn btn-outline-2x btn-outline-primary entity-create ">
...
@push('scripts')
    ...
    <script>
        var url_banner_load = "{{ route('cuidado-personal.load') }}";
        var update_order_banner = "{{ route('cuidado-personal.update-order') }}";
    </script>
    ...
    <script src="{{ asset('app/cuidado-personal/index.js') }}"></script>
