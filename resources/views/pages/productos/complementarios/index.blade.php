                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <label class="field">
                                        ...
                                        <input type="text" class="form-control gui-input" value="{{$product->category?$product->category->name:''}}"   type="text"  readonly>
...
@push('scripts')
    ...
    <script>
        var url_producto_relacionada_load = "{{route('products.complemetario.load',$product->id)}}";
        var  url_producto_list_load= "{{route('products.complemetario.list-load',$product->id)}}";
        var url_save_relacionada="{{route('products.complemetario.store')}}";
