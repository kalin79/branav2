            ...
            <div class="main-card mb-3 card">
                <div class="mb-1 card  m-0 p-0">
                    ...
                    <div class="admin-form theme-primary">
                        <form method="POST" action="{{ route('products.store') }}" id="form-product" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body ">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab-eg7-0" role="tabpanel">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="position-relative form-group">
                                                    <label class="field">
                                                        ...
                                                        <input name="title_small" id="title_small" placeholder="Subtitulo" type="text" class="form-control gui-input">
                                                    </label>
                                            ...
                                            <div class="col-md-2">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <input name="presentacion" id="presentacion" placeholder="Presentación" type="text" class="form-control gui-input">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <label for="precio_normal"><b>Precio Actual</b></label>
                                                <label class="field">
                                                    <div class="input-group input-group">
                                                        ...
                                                        <input type="text"  id="precio_normal"
                                            ...
                                            <div class="col-md-2">
                                                <label for="precio_online"><b>Precio Anterior</b></label>
                                                <label class="field">
                                                    <div class="input-group input-group">
                                                        <div class="input-group-prepend"><span
                                                        ...
                                                        <input type="text"  id="precio_online"
                                                               class="form-control gui-input only_decimal"
                                                               name="precio_online"
                                                               step=".01"
                                                               min="0"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group overflow-auto vh-75 ">
                                                    ...
                                                    <label class="field select">
                                                        <select id="cmb_categoria" name="categoria_id" class=" form-control " placeholder="Seleccione categoria" style="width: 100% !important">
                                                            <option></option>
...
{{--                                            <div class="col-md-6">--}}
{{--                                                <div class="form-group overflow-auto vh-75 ">--}}
{{--                                                    <label for="title_large"><b>Sub Categorías</b></label>--}}
{{--                                                    <label class="field select">--}}
{{--                                                        <select id="cmb_subcategoria" name="sub_categoria_id" class="form-control "  placeholder="Seleccione categoria" style="width: 100% !important">--}}
{{--                                                            <option></option>--}}
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <label class="field">
                                                    <textarea id="description_corta" class="form-control form-control-sm gui-input tinymce"
                                                            ...
                                                            placeholder="Descripción corta" rows="10"></textarea>
                                                </label>
                                            </div>
                                            <div class="form-group col-sm-6">
                                                ...
                                                <label class="field">
                                                    <textarea id="description" class="form-control form-control-sm gui-input tinymce"
                                                              name="description"
                                                              placeholder="Descripción completa" rows="10"></textarea>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-sm-6">
                                                <div class="custom-checkbox custom-control">
                                                    ...
                                                    <input type="hidden" id="descuento_producto" name="descuento_producto" value="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="tab-eg7-1" role="tabpanel">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-12">
                                                <label for="acerca_producto"><b>Descripción</b></label>
                                                <label class="field">
                                                    <textarea id="acerca_producto" class="form-control form-control-sm gui-input tinymce"
                                            ...
                                            <div class="form-group col-sm-12">
                                                ...
                                                <label class="field">
                                                    <textarea id="como_usarlo" class="form-control form-control-sm gui-input tinymce"
                                                              name="como_usarlo"
                                                              placeholder="Como usarlo" rows="10"></textarea>
                                                </label>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-file">
                                                        ...
                                                        <label class="custom-file-label" for="poster" id="file-label-pc"></label>
                                                    </div>
                                                    <small>* [1000*1000] Sólo imágenes JPG y PNG, Máximo de 1M</small>
                                                </div>
                                                <div class="col-sm-2">
