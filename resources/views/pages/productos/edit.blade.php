        ...
        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
            <div class="main-card mb-3 card">
                ...
                <div class="admin-form theme-primary">
                    <form method="POST" action="{{ route('products.update', $product->id) }}" id="form-product"
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab-eg7-0" role="tabpanel">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="position-relative form-group">
                                                <label class="field">
                                                    ...
                                                    <input name="title_small" id="title_small"
                                                        value="{{$product->title_small}}" placeholder="Subtitulo"
                                                        type="text" class="form-control gui-input">
                                                </label>
                                        ...
                                        <div class="col-md-2">
                                            <div class="position-relative form-group">
                                                ...
                                                <input name="presentacion" id="presentacion" placeholder="Presentación"
                                                    type="text" class="form-control gui-input"
                                    ...
                                    <div class="row">
                                            ...
                                            <label class="field">
                                                <div class="input-group input-group">
                                                    ...
                                                    <input type="text" id="price_normal"
                                                        class="form-control gui-input only_decimal " name="precio_normal"
                                                        placeholder="0.00" step=".01" min="0"
                                            ...
                                            <label class="field">
                                                <div class="input-group input-group">
                                                    ...
                                                    <input type="text" id="price_online"
                                                        class="form-control gui-input only_decimal" name="precio_online"
                                                        step=".01" min="0" placeholder="0.00"
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="number" id="stock" class="form-control form-control only_number"
                                                name="stock" min="0" placeholder="Ingresar Stock"
                                                value="{{$product->stock}}">
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group overflow-auto vh-75 ">
                                                ...
                                                <label class="field select">
                                                    <select id="cmb_categoria" name="categoria_id" class=" form-control "
                                                        placeholder="Seleccione categoria" style="width: 100% !important">
                                                        <option></option>
                                                        @foreach ($categorias as $categoria)
                                                            <option value="{{$categoria->id}}"
                                                                @if($product->categoria_id == $categoria->id) selected @endif>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group overflow-auto vh-75 ">
                                                ...
                                                <label class="field select">
                                                    <select id="cmb_subcategoria" name="sub_categoria_id"
                                                        ...
                                                        @foreach ($sub_categorias as $sub_categoria)
                                                            <option value="{{$sub_categoria->id}}"
                                                                @if($sub_categoria->id == $product->sub_categoria_id) selected
                                                                @endif>{{$sub_categoria->titulo}}</option>
                                                        @endforeach
                                                    </select>
                                                </label>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-6">
                                            ...
                                            <label class="field">
                                                <textarea id="description_small"
                                                    class="form-control form-control-sm tinymce" name="description_small"
                                                    placeholder="Descripción corta"
                                                    rows="10">{{$product->description_small}}</textarea>
                                            </label>
                                        </div>
                                        <div class="form-group col-sm-6">
                                            ...
                                            <label class="field ">
                                                <textarea id="description" class="form-control form-control-sm tinymce"
                                                    name="description" placeholder="Descripción completa"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-6">
                                            <div class="custom-checkbox custom-control">
                                                <input type="checkbox" id="check_descuento" class="custom-control-input"
                                                    @if($product->descuento_producto) checked @endif>
                                                <label class="custom-control-label" for="check_descuento"><b>Aplicar
                                                        Descuento</b></label>
                                                <input type="hidden" id="descuento_producto" name="descuento_producto"
                                    ...
                                    {{-- <div class="row">--}}
                                        {{-- <div class="form-group col-sm-6">--}}
                                            {{-- <div class="custom-checkbox custom-control">--}}
                                                {{-- <input type="checkbox" id="check_dia_especial"
                                                    class="custom-control-input" @if($product->dia_especial) checked
                                                @endif>--}}
                                                {{-- <label class="custom-control-label" for="check_dia_especial">Check para
                                                    agregar producto a día especial</label>--}}
                                                {{-- <input type="hidden" id="valor_dia_especial" name="dia_especial"
                                                    value="{{$product->dia_especial}}">--}}
                                                {{-- </div>--}}
                                            {{-- </div>--}}
                                ...
                                <div class="tab-pane" id="tab-eg7-1" role="tabpanel">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label" for="poster"
                                                        id="file-label-acerca-producto"></label>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-12">
                                            ...
                                            <label class="field">
                                                <textarea id="description_corta"
                                                    class="form-control form-control-sm gui-input tinymce"
                                                    name="acerca_producto" placeholder="Descripción"
                                                    rows="10">{{$product->acerca_producto}}</textarea>
                                            </label>
                                        </div>
                                ...
                                <div class="tab-pane" id="tab-eg7-2" role="tabpanel">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label" for="poster"
                                                        id="file-label-como-usarlo"></label>
                                                </div>
                                                <small>* [1000*1000] Sólo imágenes JPG y PNG, Máximo de 1M</small>
                                            </div>
                                            <div class="col-sm-2">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-12">
                                            ...
                                            <label class="field">
                                                <textarea id="como_usarlo"
                                                    class="form-control form-control-sm gui-input tinymce"
                                                    name="como_usarlo" placeholder="Como usarlo"
                                                    rows="10">{{$product->como_usarlo}}</textarea>
                                            </label>
                                        </div>
                                ...
                                <div class="tab-pane" id="tab-eg7-3" role="tabpanel">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="file" accept="image/*" class="galeria" id="galeria"
                                                    name="gallery[]" lang="es" multiple="multiple">
                                                <small>* [1000*1000] Sólo imágenes JPG y PNG, Máximo de 1M</small>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="table-wrap">
                                                <div id="table-content-gallery" class="table-responsive">
                                                    ...
                                                    <div id="loading" class="text-center">
                                                        <i class="fa fa-spinner fa-pulse fa-lg p-5" role="status"
                                                            aria-hidden="true"></i>
                                                    </div>
                                                </div>
                                            </div>
