        ...
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                ...
                <div class="d-inline-block" style="background: white">
                    <a href="{{ route('products.create') }}" class="btn btn-outline-2x btn-outline-primary entity-create ">
...
@push('scripts')
    ...
    <script>
        var url_products_load = "{{ route('products.load') }}";
        var url_categorias_lista = "{{route('categories.list-category')}}";
    </script>
