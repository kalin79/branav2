    ...
    <tbody>
        @forelse ($productos as $producto)
            <tr>
                <td>
                    @if($producto->poster)
                        <img src="{{ $producto->poster_url }}" width="80px">
                    @endif
                </td>
                <td>
                ...
                <td width="150px">
                    ...
                    <a title="Editar" data-name="{{ $producto->title_small }}"
                        href="{{ route('products.edit', $producto->id) }}" class="btn btn-outline-info btn-sm edit-entity">
                        <i class="fa fa-pen"></i>
                    </a> &nbsp;
